        ...
        binding.buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedSemester == null){
                    ...
                    Grade newGrade =  new Grade(selectedSemester.getName(),selectedCourse.getName(),selectedLetterGrade.getLetterGrade(),selectedCourse.getHours());
                    mListener.onAddGrade(newGrade);
                }
            }
        });
