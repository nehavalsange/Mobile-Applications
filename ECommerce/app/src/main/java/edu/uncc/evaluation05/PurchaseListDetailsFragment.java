...
public class PurchaseListDetailsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        for(Product product: mPurchaseList.getItems()){
            mProducts.add(product);
            overAllCost = overAllCost + product.getPrice_per_item();
        }
    ...
    class PurchaseListProductsAdapter extends RecyclerView.Adapter<PurchaseListProductsAdapter.PurchaseListViewHolder> {
        ...
        class PurchaseListViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(Product product) {
                ...
                itemBinding.textViewItemCount.setText(String.valueOf(product.getQuantity()));
                Picasso.get().load(product.getImg_url()) // Pass the URL
                        .into(itemBinding.imageViewIcon);
                binding.textViewTotalCost.setText(String.valueOf(overAllCost));
            }
        }
    }
