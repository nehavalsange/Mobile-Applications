...
//                                authResponse.setToken(body);
//                                authResponse.setUser_fullname(name);
//                                authResponse.setUser_id("1");
                                ...
                                getActivity().runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(getActivity(),"Unable to register",Toast.LENGTH_LONG).show();
